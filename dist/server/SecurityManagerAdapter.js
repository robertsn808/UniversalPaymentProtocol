...
export class SecurityManagerAdapter {
    ...
    async detectFraud(amount, deviceId, context) {
        const flags = [];
        let riskScore = 0;
    ...
    async attestDevice(fingerprint, context) {
    ...
    async authenticateBiometric(data) {
        ...
        const threshold = thresholds[data.type] || 0.8;

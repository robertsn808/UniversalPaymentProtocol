...
export class VoiceAssistantAdapter {
    constructor(deviceInfo) {
        ...
        this.deviceType = 'voice_assistant';
        this.capabilities = {
    ...
    async listenForInput(timeout = 10000) {
    ...
    async handleNaturalLanguageRequest(transcript) {
    ...
    async playAudioFeedback(feedbackType) {
    ...
    async handleVoiceAuthentication() {
    ...
    async triggerSmartHomeAction(action) {

...
app.post('/api/process-payment', optionalAuth, asyncHandler(async (req, res) => {
    ...
    try {
        ...
        await transactionRepository.updateStatus(transactionId, result.success ? 'completed' : 'failed', result.error_message);
...
app.post('/api/register-device', optionalAuth, asyncHandler(async (req, res) => {
    // Validate request data
...
app.get('/api/device/:deviceId', optionalAuth, asyncHandler(async (req, res) => {
...
app.get('/api/devices', optionalAuth, asyncHandler(async (req, res) => {
...
app.get('/api/transaction/:transactionId', optionalAuth, asyncHandler(async (req, res) => {
...
app.get('/api/user/devices', authenticateToken, asyncHandler(async (req, res) => {
    const { page = 1, limit = 10, status, device_type } = req.query;
    const devices = await deviceRepository.findMany({
...
app.get('/api/user/transactions', authenticateToken, asyncHandler(async (req, res) => {

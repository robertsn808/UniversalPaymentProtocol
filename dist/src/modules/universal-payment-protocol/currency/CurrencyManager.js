...
export class CurrencyManager {
    constructor() {
        ...
        this.rateProviders = ['fixer.io', 'exchangerate-api', 'currencylayer'];
    ...
    async convertCurrency(amount, fromCurrency, toCurrency, userPreferences) {
    ...
    async detectPreferredCurrency(location) {
    ...
    async getExchangeRateTrends(fromCurrency, toCurrency, days = 30) {
    ...
    async convertCryptoCurrency(amount, fromCrypto, toFiat) {
    ...
    async generateMockExchangeRates() {
    ...
    generateMockRate(fromCurrency, toCurrency) {
    ...
    async getCryptoExchangeRate(cryptoCurrency, fiatCurrency) {
    ...
    async logCurrencyConversion(conversion) {

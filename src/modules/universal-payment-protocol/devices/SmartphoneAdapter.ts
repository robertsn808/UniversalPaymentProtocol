...
import { UPPDevice, DeviceCapabilities, SecurityContext } from '../core/types.js';

export class SmartphoneAdapter implements UPPDevice {
  public deviceType: string = 'smartphone';
  ...
  async handleError(error: any): Promise<void> {
    ...
    const userMessage = errorTypes[error.type as keyof typeof errorTypes] || 
  ...
  private async displaySuccessUI(details: any): Promise<void> {
  ...
  private async displayErrorUI(error: any): Promise<void> {
